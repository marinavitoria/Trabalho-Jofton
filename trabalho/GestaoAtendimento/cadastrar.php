...
<div class="container">
  ...
  <form action="conexao/atendimentoCadastrar.php" method="post">
    <br>
    <div class="mb-3">
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" name="educador"  id="exampleFormControlInput1" placeholder="Digite o nome" required>
</div>
<br>
